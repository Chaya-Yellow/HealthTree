...
public class OximetTamp {
    ...
    public String toString() {
        return "Oximet [id=" + id + ", valueId=" + valueId + ", familyID=" + familyID + ", memberId=" + memberId +  ", part=" + part + ", SPO2=" + SPO2
                ...
                + ", updatedDate=" + updatedDate + ", record_date=" + record_date + ", created_date=" + created_date
                + ", updated_date=" + updated_date + ", isDeleted=" + isDeleted + ", is_deleted=" + is_deleted + ", timestamp=" + timestamp + "]";
    }
}
