...
+(NSString*)getDeviceType{
    ...
    if ([platform isEqualToString:@"iPhone11,2"])    return @"IPhone_X";
    if ([platform isEqualToString:@"iPhone11,4"])    return @"IPhone_X";
    if ([platform isEqualToString:@"iPhone11,6"])    return @"IPhone_X";
    if ([platform isEqualToString:@"iPhone11,8"])    return @"IPhone_X";
...
+ (NSString *)toTheHex:(NSInteger)input
{
    ...
    switch (input) {
        ...
        case 15:
            ...
            break;
        default:
            result = [NSString stringWithFormat:@"%d",input];
            break;
    }
    return result;
}
